...
func Load() *Config {
	...
	config := &Config{
		...
		MongoURI:     getEnvWithDefault("MONGO_URI", "mongodb+srv://root:bfw9sJjTXxfleyu7@localdevincidents.voqqf7r.mongodb.net/localdevincidents?retryWrites=true&w=majority&ssl=true&sslInsecure=true"),
